...
do_compile() {
    ${CC} ${SOURCE_FILES} -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D_LARGEFILE_SOURCE -D_GNU_SOURCE=1 -Wall -Wstrict-prototypes -Wmissing-prototypes -Wmissing-declarations -Wno-deprecated-declarations -Wshadow -Wpointer-arith -Wcast-qual -Wsign-compare -DPREFIX="${prefix}" -std=gnu99 -I${S}/src -I${D}${libdir} -I${D}${includedir} -lrt -lpthread -lz -lssl -lcrypto -lcurl -o hlsdl ${LDFLAGS}
}
