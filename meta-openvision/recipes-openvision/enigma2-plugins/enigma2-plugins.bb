...
RDEPENDS_enigma2-plugin-extensions-mytube = "${PYTHONNAMEONLY}-twisted-web python-gdata ${@bb.utils.contains("GST_VERSION", "1.0", "gstreamer${GST_VERSION}", "gst", d)}-plugins-good-flv python-textutils ${PYTHONNAMEONLY}-json ${PYTHONNAMEONLY}-google-api-client ${PYTHONNAMEONLY}-httplib2 python-youtube-dl ${PYTHONNAMEONLY}-ctypes"
RDEPENDS_enigma2-plugin-extensions-ncidclient = "${PYTHONNAMEONLY}-twisted-web ${PYTHONNAMEONLY}-html python-textutils"
RDEPENDS_enigma2-plugin-extensions-netcaster = "${@bb.utils.contains("GST_VERSION", "1.0", "gstreamer${GST_VERSION}", "gst", d)}-plugins-good-icydemux"
...
RDEPENDS_enigma2-plugin-extensions-yttrailer = "${PYTHONNAMEONLY}-twisted-web python-gdata ${@bb.utils.contains("GST_VERSION", "1.0", "gstreamer${GST_VERSION}", "gst", d)}-plugins-good-flv"
