...
RDEPENDS_enigma2-plugin-extensions-mytube = "${PYTHONNAMEONLY}-twisted-web python-gdata ${GSTVNAME}-plugins-good-flv python-textutils ${PYTHONNAMEONLY}-json ${PYTHONNAMEONLY}-google-api-client ${PYTHONNAMEONLY}-httplib2 python-youtube-dl ${PYTHONNAMEONLY}-ctypes"
RDEPENDS_enigma2-plugin-extensions-ncidclient = "${PYTHONNAMEONLY}-twisted-web ${PYTHONNAMEONLY}-html python-textutils"
RDEPENDS_enigma2-plugin-extensions-netcaster = "${GSTVNAME}-plugins-good-icydemux"
...
RDEPENDS_enigma2-plugin-extensions-yttrailer = "${PYTHONNAMEONLY}-twisted-web python-gdata ${GSTVNAME}-plugins-good-flv"
