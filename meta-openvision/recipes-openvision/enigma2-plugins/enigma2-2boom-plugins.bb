...
FILES_enigma2-plugin-extensions-quickecminfo_append = " ${libdir}/enigma2/python/Components/Converter/QuickEcmInfo2.${PYTHONEXTENSION} "
...
FILES_enigma2-plugin-extensions-updatepreview_append = " ${libdir}/enigma2/python/Screens/Console2.${PYTHONEXTENSION} "
