...
do_install() {
	...
	install -m 0644 ${S}${base_libdir}/python/Plugins/Extensions/HbbTV/*.${PYTHONEXTENSION}  ${D}${libdir}/enigma2/python/Plugins/Extensions/HbbTV
	...
	install -m 0644 ${S}${base_libdir}/python/Components/Sources/HbbtvApplication.${PYTHONEXTENSION}  ${D}${libdir}/enigma2/python/Components/Sources
	install -d ${D}${libdir}/enigma2/python/Components/Converter
	install -m 0644 ${S}${base_libdir}/python/Components/Converter/HbbtvApplicationInfo.${PYTHONEXTENSION}  ${D}${libdir}/enigma2/python/Components/Converter
