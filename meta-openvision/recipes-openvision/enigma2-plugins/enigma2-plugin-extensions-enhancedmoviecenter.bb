...
RDEPENDS_${PN} = "gstreamer${GST_VERSION}-plugins-good-flv gstreamer${GST_VERSION}-plugins-bad-rtmp ${PYTHONNAMEONLY}-json ${PYTHONNAMEONLY}-html ${PYTHONNAMEONLY}-requests python-mutagen rtmpdump"
